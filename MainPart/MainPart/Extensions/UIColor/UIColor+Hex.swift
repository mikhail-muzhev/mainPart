...
extension UIColor {
    ...
    public func hexString(_ includeAlpha: Bool = true) -> String {
        ...
        self.getRed(&rComponent, green: &gComponent, blue: &bComponent, alpha: &aComponent)
        
        if includeAlpha {
            return String(format: "#%02X%02X%02X%02X", Int(rComponent * 255), Int(gComponent * 255), Int(bComponent * 255), Int(aComponent * 255))
        } else {
            return String(format: "#%02X%02X%02X", Int(rComponent * 255), Int(gComponent * 255), Int(bComponent * 255))
        }
    }
}
